...
#import "WFPersistenceController.h"

@interface WFPersistenceController()
...
@implementation WFPersistenceController

+ (instancetype)sharedPersistenceController {
    static WFPersistenceController *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [WFPersistenceController new];
    });
...
- (void)initializeCoreData {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WFWeatherModel"
                                              withExtension:@"momd"];
    ...
    NSURL *storeURL = [documentsURL URLByAppendingPathComponent:@"WFWeatherModel.sqlite"];
    NSError *error = nil;
