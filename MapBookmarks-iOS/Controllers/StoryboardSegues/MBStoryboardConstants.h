...
extern NSString *const kMBPinsOnScreenCellIdentifier;
extern NSString *const kMBBookmarksCellIdentifier;
extern NSString *const kMBNearbyPlacesCellIdentifier;
